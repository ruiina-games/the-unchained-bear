...
func increase_critical_chance(amount: float) -> void:
	critical_chance = clampf(critical_chance + amount, 0.0, 0.8)
...
func increase_dodge_chance(amount: float) -> void:
	dodge_chance = clampf(dodge_chance + amount, 0.0, 0.8)
...
func increase_status_resist_multiplier(amount: float) -> void:
	status_resist_multiplier = clampf(status_resist_multiplier + amount, 0.0, 0.8)
