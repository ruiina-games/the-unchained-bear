...
func receive_reward(reward, item_name):
	...
	if item_name == "UPGRADE":
		...
		player_contoller.actor.character_stats.add_temporary_upgrade(reward)
		...
		player_contoller.actor.character_stats.money_dictionary[PlayerStats.MONEY.TOKENS] += reward
		player_contoller.actor.character_stats.stats_upgraded.emit()
		...
		player_contoller.actor.character_stats.money_dictionary[PlayerStats.MONEY.TICKETS] += reward
		player_contoller.actor.character_stats.stats_upgraded.emit()
